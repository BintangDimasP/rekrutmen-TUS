...
<div class="max-w-6xl mx-auto space-y-6">
    ...
    <div class="flex items-center gap-2 text-sm text-gray-500">
        <a href="{{ route('kaprodi.dashboard') }}" class="hover:text-[#8b1515] transition-colors font-medium">Dashboard</a>
        <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>
        <span class="font-semibold text-gray-800">Daftar Pelamar</span>
    </div>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            ...
            <table class="w-full text-left border-collapse table-fixed">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors">
                        ...
                        <td class="py-3 px-5 text-center">
                            <a href="{{ route('kaprodi.pelamar.show', $pelamar) }}" class="inline-flex items-center justify-center p-1.5 text-gray-400 hover:text-blue-600 hover:bg-blue-50 rounded transition-colors" title="Lihat Detail">
        ...
        @include('components.pagination', ['paginator' => $pelamars])
    </div>
