...
@section('content')
    ...
    <div class="max-w-6xl mx-auto">
        ...
        {{-- Header Data --}}
        <div class="mb-6">
            <h1 class="text-2xl font-bold text-gray-800">Manajemen Kredensial & Akses</h1>
            <p class="text-sm text-gray-500 mt-1">Kelola email masuk dan reset kata sandi untuk semua pengguna sistem.</p>
        </div>
            ...
            <div class="p-5 border-b border-gray-100 bg-gray-50/50 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                ...
                <div class="flex items-center gap-3 w-full sm:w-auto">
                    <div class="relative w-full sm:w-64">
                        ...
                        <input type="text" placeholder="Cari nama atau email..." class="w-full pl-9 pr-4 py-2 rounded-lg border border-gray-200 bg-white text-sm focus:outline-none focus:border-[#8b1515] focus:ring-1 focus:ring-[#8b1515] transition shadow-sm">
                    </div>
                </div>
                ...
                <div class="flex items-center gap-3">
                    ...
                    {{-- Di sini admin tidak membuat user manual. --}}
                </div>
                ...
                <table class="w-full text-left border-collapse">
                    <thead>
                        <tr class="bg-[#8b1515] text-white">
                            <th class="py-3 px-5 text-sm font-bold whitespace-nowrap">Nama Lengkap</th>
                            <th class="py-3 px-5 text-sm font-bold whitespace-nowrap">Email (Akses Login)</th>
