                                ...
                                <div x-show="openDeleteModal" x-transition.opacity
                                    ...
                                    <div x-show="openDeleteModal"
                                        ...
                                        <div class="flex justify-center gap-3">
                                            <form method="POST" action="{{ route('admin.user.destroy', $user) }}" class="flex-1 m-0">
                                                @csrf
                                                @method('DELETE')
                                            ...
                                            <button type="button" @click="openDeleteModal = false" class="flex-1 w-full px-5 py-3 text-sm font-bold text-white bg-[#8b1515] hover:bg-red-800 active:scale-95 rounded-xl shadow-md transition-all">No</button>
                                        </div>
                                    </div>
                                </div>
                                @endif
