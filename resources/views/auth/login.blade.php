        ...
        <div class="w-full max-w-[420px]">
            ...
            <form action="{{ route('login') }}" method="POST" class="space-y-5">
                ...
                <div>
                    ...
                    <div class="relative">
                        <input id="email" type="email" name="email" value="{{ old('email') }}" placeholder="nama@email.com" required autofocus class="w-full px-4 py-3.5 rounded-lg border border-gray-200 focus:border-[#b91c1c] focus:ring-1 focus:ring-[#b91c1c] outline-none transition-colors pr-12 text-sm placeholder-gray-400 bg-gray-50/50 focus:bg-white">
                ...
                <div>
                    ...
                    <div class="relative">
                        <input id="password" type="password" name="password" placeholder="••••••••" required class="w-full px-4 py-3.5 rounded-lg border border-gray-200 focus:border-[#b91c1c] focus:ring-1 focus:ring-[#b91c1c] outline-none transition-colors pr-12 text-sm placeholder-gray-400 bg-gray-50/50 focus:bg-white">
                ...
                <div class="flex items-center justify-between text-sm py-1">
                    <label class="flex items-center gap-2 cursor-pointer text-gray-600 group">
                        <input type="checkbox" name="remember" class="w-4 h-4 rounded border-gray-300 text-[#b91c1c] focus:ring-[#b91c1c]" {{ old('remember') ? 'checked' : '' }}>
            ...
            <div class="mt-8 text-center">
                <p class="text-[14px] text-gray-500">Belum punya akun? <a href="{{ route('register') }}" class="text-[#b91c1c] hover:underline font-semibold">Daftar Sekarang</a></p>
            </div>
        </div>
    </div>
